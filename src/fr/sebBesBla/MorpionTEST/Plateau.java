	...
	public boolean victoire(char joueur) {
		...
		for (row=0; row<taillePlateau; row++) {
			...
			if (vic == true) {
				victoire = true;
				if (joueur == 'X') {
					System.out.println("Vous gagnez ŕ la ligne "+(row+1));
				} else if (joueur == '0') {
					System.out.println("L'ordinateur gagne ŕ la ligne "+(row+1));
				}
		...
		for (col=0; col<taillePlateau; col++) {
			...
			if (vic == true) {
				victoire = true;
				if (joueur == 'X') {
					System.out.println("Vous gagnez ŕ la colonne "+(col+1));
				} else if (joueur == '0') {
					System.out.println("L'ordinateur gagne ŕ la colonne "+(col+1));
				}
			}
		}
